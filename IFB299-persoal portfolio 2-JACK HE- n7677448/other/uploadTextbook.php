...
if(isset($_POST['submit'])){
	...
	if ($valid == true) {
		try{
			...
			$sql = $dbconn->prepare('INSERT INTO `textbooks`(`UserId`, `Title`, `ISBN`, `Subject`, `Edition`, `CondId`, `Description`, `CategoryId`, `State`, `Availability`) VALUES
			...
			$sql->bindParam(':cat', $category);
                        $sql->bindParam(':cat', $availability);
			$result = $sql->execute();
