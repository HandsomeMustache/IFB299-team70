...
<input type="submit" class="col-xs-12 btn btn-primary btn-load btn-lg" onclick="return confirm('Do you want to reset your password')" href="" data-loading-text="Sent Email Confirmation" value="Submit">
</form>
