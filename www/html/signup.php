...
<p> <h2> Sign Up </h2> </p>
	...
	<form id="signupForm" action="core/signUpScript.php" method="POST">
	
    <label for="Username">Username</label>
    <input type="Username" class="form-control" id="user" name="user" placeholder="Username" required>
	
    <label for="email">Email address</label>
    <input type="email" class="form-control" id="email" name="email" placeholder="Email" required>
	
    <label for="inputPassword">Password</label>
    <input type="password" class="form-control" id="inputPassword" name="pass" placeholder="Confirm Password" required>
	
	
    <label for="inputPasswordConfirm">Confirm Password</label>
    <input type="password" class="form-control" id="inputPasswordConfirm" name="cpass"  data-match="#inputPassword" data-match-error="Passwords dont match fool" placeholder="Confirm" required>
