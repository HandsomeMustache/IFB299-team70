...
<div class="container" style="padding-top: 5px;">
  ...
  <div class="row">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
      <h3>Personal info</h3>
      <form name="editProfile" action="core/updateProfile.php" method="POST" class="form-horizontal" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" value=<?php echo '"'.$profile['UniId'].'"';?> type="text" name="uni">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-3 control-label">Campus:</label>
          <div class="col-lg-8">
            <input class="form-control" value=<?php echo '"'.$profile['CampusId'].'"';?> type="text" name="camp">
          </div>
        </div>
        <div class="form-group">
